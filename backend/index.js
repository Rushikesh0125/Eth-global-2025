...
const { RPC_URL, PRIVATE_KEY, CONTRACT_ADDRESS, API_KEY } = process.env;
...
app.post("/api/create-session", async (req, res) => {
  try {
    ...
    // Add this new user to Firestore (nullifier = null for now)
    await firebaseService.addUser(uuid);
...
app.post("/api/verify", async (req, res) => {
  try {
    ...
    await firebaseService.addNullifierToUser(userContextData.userId, nullifier);
